...
public class TicketModel {
    ...
    private com.hadi.trainticketing.passenger.home.model.pojo.ticket.Ticket reservationTicket;
    private String reservationId;
    private Ticket ticket;
    private List<ArrayResult> arrayResults;

    public TicketModel(String launchTime, String arrivalTime, com.hadi.trainticketing.passenger.home.model.pojo.ticket.Ticket ticket, String reservationId) {
